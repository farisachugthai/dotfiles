...
# Just switched letters. Will that stop jupyter from importing ipy configs?
j = get_config()
# Created by running
# $ jupyter notebook --generate-config

# Sep 28, 2018: Recent modifications from jupyter nteract
# Ensure everythings fixed up before pushing!
# -----------------------------------------------------------------------------
...
# j.NotebookApp.server_extensions = []

# The session manager class to use.
# j.NotebookApp.session_manager_class = 'notebook.services.sessions.sessionmanager.SessionManager'
...
# j.NotebookApp.shutdown_no_activity_timeout = 0
...
# j.ConnectionFileMixin.control_port = 0
...
# j.KernelManager.autorestart = True
...
# j.ContentsManager.hide_globs = ['__pycache__', '*.pyc', '*.pyo', '.DS_Store', '*.so', '*.dylib', '*~']
...
# j.FileContentsManager.save_script = False
