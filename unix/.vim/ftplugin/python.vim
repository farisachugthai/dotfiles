...
" For use with AleFix: Configure at will
...
"
" Don't turn EVERYTHING on. possibly turn on remove trailing lines and trim
" whitespace. then run tests to make sure everything else is here, that we're
" in the right venv or conda env etc.
