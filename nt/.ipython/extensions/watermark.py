...
Yeah so don't push this as you obviously didn't write it and have no need for it.
HOWEVER, it's a great example of how to use a dunder method in your current folder, how to get the hostname,
get sys_info AND use ipython magics.

Like there's a lot of different places you'll want to take notes on!

Also note that I opened this in powershell ISE and that while in the console I opened the file by navigating
to the dir and running psedit watermark.py [lucky guess! The command window is awesome]
"""
